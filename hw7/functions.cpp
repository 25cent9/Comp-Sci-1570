...
void initializeArray(sector array[], const int size)
{
...
void initializeArray(offender array[], const int size)
{
  for(int i =0; i<size; i++)
  {
...
void printDatabase(const sector database[],const  int size)
{
  for (int i = 0; i < size; i++)
  {
...
void printDatabase(const offender database[], const int size)
{
  for (int i = 0; i < size; i++)
  {
...
int findGuiltiestOffenders(const sector database[], const int size)
{
  int sum1 = 0;
  int sum2 = 0;
  int fracSum = 0;
...
void printSectors(const sector sectors[], const int size)
{
...
int findOffender(const sector sec[], const int size, const int user)
{
  int index = 0;
  for(int i = 0; i<size; i++)
  {
